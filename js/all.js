...
! function(n) {
    n.easing.jswing = n.easing.swing, n.extend(n.easing, {
        def: "easeOutQuad",
        swing: function(t, e, u, a, r) {
            return n.easing[n.easing.def](t, e, u, a, r)
        },
        ...
        easeInOutQuad: function(n, t, e, u, a) {
            return 1 > (t /= a / 2) ? u / 2 * t * t + e : -u / 2 * (--t * (t - 2) - 1) + e
        },
        ...
        easeInOutCubic: function(n, t, e, u, a) {
            return 1 > (t /= a / 2) ? u / 2 * t * t * t + e : u / 2 * ((t -= 2) * t * t + 2) + e
        },
        ...
        easeInOutQuart: function(n, t, e, u, a) {
            return 1 > (t /= a / 2) ? u / 2 * t * t * t * t + e : -u / 2 * ((t -= 2) * t * t * t - 2) + e
        },
        ...
        easeInOutQuint: function(n, t, e, u, a) {
            return 1 > (t /= a / 2) ? u / 2 * t * t * t * t * t + e : u / 2 * ((t -= 2) * t * t * t * t + 2) + e
        },
        ...
        easeInOutExpo: function(n, t, e, u, a) {
            return 0 == t ? e : t == a ? e + u : 1 > (t /= a / 2) ? u / 2 * Math.pow(2, 10 * (t - 1)) + e : u / 2 * (-Math.pow(2, -10 * --t) + 2) + e
        },
        ...
        easeInOutCirc: function(n, t, e, u, a) {
            return 1 > (t /= a / 2) ? -u / 2 * (Math.sqrt(1 - t * t) - 1) + e : u / 2 * (Math.sqrt(1 - (t -= 2) * t) + 1) + e
        },
        easeInElastic: function(n, t, e, u, a) {
            n = 1.70158;
            var r = 0,
                i = u;
            return 0 == t ? e : 1 == (t /= a) ? e + u : (r || (r = .3 * a), i < Math.abs(u) ? (i = u, n = r / 4) : n = r / (2 * Math.PI) * Math.asin(u / i), -(i * Math.pow(2, 10 * --t) * Math.sin(2 * (t * a - n) * Math.PI / r)) + e)
        },
        ...
        easeInOutElastic: function(n, t, e, u, a) {
            ...
            var r = 0,
                i = u;
            return 0 == t ? e : 2 == (t /= a / 2) ? e + u : (r || (r = .3 * a * 1.5), i < Math.abs(u) ? (i = u, n = r / 4) : n = r / (2 * Math.PI) * Math.asin(u / i), 1 > t ? -.5 * i * Math.pow(2, 10 * --t) * Math.sin(2 * (t * a - n) * Math.PI / r) + e : i * Math.pow(2, -10 * --t) * Math.sin(2 * (t * a - n) * Math.PI / r) * .5 + u + e)
        },
        ...
        easeInOutBack: function(n, t, e, u, a, r) {
            return void 0 == r && (r = 1.70158), 1 > (t /= a / 2) ? u / 2 * t * t * (((r *= 1.525) + 1) * t - r) + e : u / 2 * ((t -= 2) * t * (((r *= 1.525) + 1) * t + r) + 2) + e
        },
        easeInBounce: function(t, e, u, a, r) {
            return a - n.easing.easeOutBounce(t, r - e, 0, a, r) + u
        },
        ...
        easeInOutBounce: function(t, e, u, a, r) {
            return r / 2 > e ? .5 * n.easing.easeInBounce(t, 2 * e, 0, a, r) + u : .5 * n.easing.easeOutBounce(t, 2 * e - r, 0, a, r) + .5 * a + u
        }
    })
}(jQuery);
! function(i) {
...
! function(e, t, a) {
    ...
    function n(t, p, g) {
        function X(a) {
            ...
            if (Ce.old = e.extend({}, Ce), Ie = we ? 0 : be[me.horizontal ? "width" : "height"](), Te = Be[me.horizontal ? "width" : "height"](), ze = we ? t : Pe[me.horizontal ? "outerWidth" : "outerHeight"](), Ee.length = 0, Ce.start = 0, Ce.end = q(ze - Ie, 0), Re) {
                ...
                }), Pe[0].style[me.horizontal ? "width" : "height"] = (l ? ze : ze - s - o) + "px", ze -= f, Oe.length ? (Ce.start = Oe[0][je ? "center" : "start"], Ce.end = je ? r.center : ze > Ie ? r.end : Ce.start) : Ce.start = Ce.end = 0
            }
            if (Ce.center = E(Ce.end / 2 + Ce.start / 2), Q(), Se.length && Te > 0 && (me.dynamicHandle ? (ke = Ce.start === Ce.end ? Te : E(Te * Ie / ze), ke = d(ke, me.minHandleSize, Te), Se[0].style[me.horizontal ? "width" : "height"] = ke + "px") : ke = Se[me.horizontal ? "outerWidth" : "outerHeight"](), xe.end = Te - ke, it || M()), !we && Ie > 0) {
                ...
                if (Re) e.each(Oe, function(e, t) {
                    je ? Ee.push(t.center) : t.start + t.size > h && h <= Ce.end && (h = t.start, Ee.push(h), h += Ie, h > Ce.end && h < Ce.end + Ie && Ee.push(Ce.end))
                });
                else
            ...
            if (Ne.slideeSize = ze, Ne.frameSize = Ie, Ne.sbSize = Te, Ne.handleSize = ke, Re) {
                ...
                Y(Le && m ? m.center : d(Ce.dest, Ce.start, Ce.end))
            } else a ? null != me.startAt && Y(me.startAt, 1) : Y(d(Ce.dest, Ce.start, Ce.end));
            he("load")
        }
        ...
        function Y(e, t, a) {
            if (Re && at.released && !a) {
                ...
                Le ? (i && (e = Oe[n.centerItem].center), je && me.activateMiddle && U(n.centerItem)) : i && (e = Oe[n.firstItem].start)
            }
            at.init && at.slidee && me.elasticBounds ? e > Ce.end ? e = Ce.end + (e - Ce.end) / 6 : e < Ce.start && (e = Ce.start + (e - Ce.start) / 6) : e = d(e, Ce.start, Ce.end), et.start = +new Date, et.time = 0, et.from = Ce.cur, et.to = e, et.delta = e - Ce.cur, et.tweesing = at.tweese || at.init && !at.slidee, et.immediate = !et.tweesing && (t || at.init && at.slidee || !me.speed), at.tweese = 0, e !== Ce.dest && (Ce.dest = e, he("change"), it || H()), K(), Q(), Z(), F()
        }

        function H() {
            if (ye.initialized) {
                if (!it) return it = w(H), void(at.released && he("moveStart"));
                et.immediate ? Ce.cur = et.to : et.tweesing ? (et.tweeseDelta = et.to - Ce.cur, x(et.tweeseDelta) < .1 ? Ce.cur = et.to : Ce.cur += et.tweeseDelta * (at.released ? me.swingSpeed : me.syncSpeed)) : (et.time = O(+new Date - et.start, me.speed), Ce.cur = et.from + et.delta * e.easing[me.easing](et.time / me.speed, et.time, 0, 1, me.speed)), et.to === Ce.cur ? (Ce.cur = et.to, at.tweese = it = 0) : it = w(H), he("move"), we || (f ? Pe[0].style[f] = v + (me.horizontal ? "translateX" : "translateY") + "(" + -Ce.cur + "px)" : Pe[0].style[me.horizontal ? "left" : "top"] = -E(Ce.cur) + "px"), !it && at.released && he("moveEnd"), M()
            }
        }
        ...
        function j() {
            tt.speed && Ce.cur !== (tt.speed > 0 ? Ce.end : Ce.start) || ye.stop(), ot = at.init ? w(j) : 0, tt.now = +new Date, tt.pos = Ce.cur + (tt.now - tt.lastTime) / 1e3 * tt.speed, Y(at.init ? tt.pos : E(tt.pos)), at.init || Ce.cur !== Ce.dest || he("moveEnd"), tt.lastTime = tt.now
        }

        function L(e, t, n) {
            if ("boolean" === i(t) && (n = t, t = a), t === a) Y(Ce[e], n);
            else {
        ...
        function G(e, t, a) {
            if (e = W(e), t = W(t), e > -1 && t > -1 && e !== t && (!a || t !== e - 1) && (a || t !== e + 1)) {
                ...
                var n = t > e ? e : a ? t : t - 1,
                    i = e > t ? e : a ? t + 1 : t,
                    r = e > t;
                null != Ne.activeItem && (e === Ne.activeItem ? _e.active = Ne.activeItem = a ? r ? t + 1 : t : r ? t : t - 1 : Ne.activeItem > n && Ne.activeItem < i && (_e.active = Ne.activeItem += r ? 1 : -1)), X()
            }
        }
        ...
        function ae(e) {
            if (at.released = "mouseup" === e.type || "touchend" === e.type, at.pointer = at.touch ? e.originalEvent[at.released ? "changedTouches" : "touches"][0] : e, at.pathX = at.pointer.pageX - at.initX, at.pathY = at.pointer.pageY - at.initY, at.path = D(A(at.pathX, 2) + A(at.pathY, 2)), at.delta = me.horizontal ? at.pathX : at.pathY, at.released || !(at.path < 1)) {
                ...
                r(e), !at.locked && at.path > at.pathToLock && at.slidee && (at.locked = 1, at.$source.on(B, s)), at.released && (ne(), me.releaseSwing && at.slidee && (at.swing = (at.delta - at.history[0]) / 40 * 300, at.delta += at.swing, at.tweese = x(at.swing) > 10)), Y(at.slidee ? E(at.initPos - at.delta) : V(at.initPos + at.delta))
            }
        }
        ...
        function ce(e) {
            me.clickBar && e.target === Be[0] && (r(e), Y(V((me.horizontal ? e.pageX - Be.offset().left : e.pageY - Be.offset().top) - ke / 2)))
        }
        ...
        var pe, ge, me = e.extend({}, n.defaults, p),
            ...
            Me = new u(Se[0]),
            Fe = "basic" === me.itemNav,
            je = "forceCentered" === me.itemNav,
            Le = "centered" === me.itemNav || je,
            Re = !we && (Fe || Le || je),
        ...
        we || (t = be[0]), ye.initialized = 0, ye.frame = t, ye.slidee = Pe[0], ye.pos = Ce, ye.rel = Ne, ye.items = Oe, ye.pages = Ee, ye.isPaused = 0, ye.options = me, ye.dragging = at, ye.reload = function() {
            ...
            tt.speed = e, !at.init && tt.speed && Ce.cur !== (tt.speed > 0 ? Ce.end : Ce.start) && (tt.lastTime = +new Date, tt.startPos = Ce.cur, ee("button"), at.init = 1, he("moveStart"), y(ot), j())
        }, ye.stop = function() {
            ...
            e && (Re ? ye[Le ? "toCenter" : "toStart"](d((Le ? Ne.centerItem : Ne.firstItem) + me.scrollBy * e, 0, Oe.length)) : Y(Ce.dest + e, t))
            ...
            var n = e(t);
            Re ? (null == a || !Oe[0] || a >= Oe.length ? n.appendTo(Pe) : Oe.length && n.insertBefore(Oe[a].el), null != Ne.activeItem && a <= Ne.activeItem && (_e.active = Ne.activeItem += n.length)) : Pe.append(n), X()
            ...
            if (Re) {
                ...
                if (a > -1) {
                    ...
                    null != Ne.activeItem && a < Ne.activeItem && (_e.active = --Ne.activeItem), X(), n && (_e.active = null, ye.activate(Ne.activeItem))
                }
            } else e(t).remove(), X()
            ...
            if (!ye.initialized) {
                ...
                return we || (a = a.add(Pe), be.css("overflow", "hidden"), f || "static" !== be.css("position") || be.css("position", "relative")), f ? v && a.css(f, v) : ("static" === Be.css("position") && Be.css("position", "relative"), a.css({
                    ...
                    source: "handle"
                }, te), b.on("keydown", de), we || (be.on("mouseenter." + m + " mouseleave." + m, ve), be.on("scroll." + m, o)), ye.initialized = 1, X(!0), me.cycleBy && !we && ye[me.startPaused ? "pause" : "resume"](), ye
            }
        }
    }
    ...
    var f, v, h, p = "sly",
        ...
        N = 0;
    b.on(C, function(e) {
            null == e.originalEvent[m] && (N = +new Date)
        }),
        function(e) {
            function t(e) {
...
! function(e, t) {
    var a = {
        ...
        init: function(t) {
            var a, r, n;
            t.originalEvent.origin.match(/vimeo/g) && "data" in t.originalEvent && (n = "string" === e.type(t.originalEvent.data) ? e.parseJSON(t.originalEvent.data) : t.originalEvent.data, n && (a = this.setPlayerID(n), a.length && (r = this.setVimeoAPIurl(a), n.hasOwnProperty("event") && this.handleEvent(n, a, r), n.hasOwnProperty("method") && this.handleMethod(n, a, r))))
        },
        ...
        handleEvent: function(t, a, r) {
            switch (t.event.toLowerCase()) {
                case "ready":
                    for (var n in e._data(a[0], "events")) n.match(/loadProgress|playProgress|play|pause|finish|seek|cuechange/) && a[0].contentWindow.postMessage(JSON.stringify({
                        method: "addEventListener",
                        value: n
                    }), r);
                    if (a.data("vimeoAPICall")) {
                        for (var i = a.data("vimeoAPICall"), o = 0; o < i.length; o++) a[0].contentWindow.postMessage(JSON.stringify(i[o].message), i[o].api);
                        a.removeData("vimeoAPICall")
                    }
                    a.data("vimeoReady", !0), a.triggerHandler("ready");
                    break;
                case "seek":
    ...
    jQuery(document).ready(function() {
        ...
        if ("string" == typeof r && (i.method = r), void 0 !== typeof n && "function" != typeof n && (i.value = n), "iframe" === e.prop("tagName").toLowerCase() && i.hasOwnProperty("method"))
            if (e.data("vimeoReady")) e[0].contentWindow.postMessage(JSON.stringify(i), a.setVimeoAPIurl(e));
            else {
        ...
        return "get" !== r.toString().substr(0, 3) && "paused" !== r.toString() || "function" != typeof n || (! function(e, r, n) {
            var i = t.setInterval(function() {
                a.catchMethods.methodreturn.length != e && (t.clearInterval(i), r(a.catchMethods.methodreturn[n]))
            }, 10)
        }(o, n, a.catchMethods.count), a.catchMethods.count++), e
...
(function() {
    var t = jQuery,
        i = function() {
            function t() {
                this.alwaysShowNavOnTouchDevices = !1, this.fadeDuration = 500, this.fitImagesInViewport = !0, this.positionFromTop = 50, this.resizeDuration = 700, this.showImageNumberLabel = !0, this.wrapAround = !1
            }
        ...
        e = function() {
            ...
            return i.prototype.init = function() {
                ...
                if ("undefined" != typeof this.album[this.currentImageIndex].title && "" !== this.album[this.currentImageIndex].title && this.$lightbox.find(".lb-caption").html(this.album[this.currentImageIndex].title).fadeIn("fast").find("a").on("click", function(i) {
                    ...
                    var e = this.options.albumLabel(this.currentImageIndex + 1, this.album.length);
...
! function e(t, i, s) {
    ...
    2: [function(e, t) {
        function i(e, t) {
            ...
            var r;
            return e.nodeName ? "img" !== e.nodeName.toLowerCase() ? t(new Error("Element supplied is not an image")) : e.src && e.complete && void 0 !== e.naturalWidth ? t(null, !0) : (i(e, "load", !0, n), i(e, "error", !0, n), void((e.readyState || e.complete) && (r = e.src, e.src = s, e.src = r))) : t(new Error("First argument must be an image element"))
        }
        ...
        var P = function() {
            ...
            function s() {
                function e(e) {
                    ...
                    if ("scroll" === F) {
                        var w, T, k, E = /^x$/i.test(l.axis) ? "Left" : "Top",
                            j = parseFloat(l.offset) || 0;
                        l.container ? m.isWrapped(l.container) || m.isNode(l.container) ? (l.container = l.container[0] || l.container, w = l.container["scroll" + E], k = w + f(s).position()[E.toLowerCase()] + j) : l.container = null : (w = b.State.scrollAnchor[b.State["scrollProperty" + E]], T = b.State.scrollAnchor[b.State["scrollProperty" + ("Left" === E ? "Top" : "Left")]], k = f(s).offset()[E.toLowerCase()] + j), p = {
                            scroll: {
                                rootPropertyValue: !1,
                                startValue: w,
                                currentValue: w,
                        ...
                        var H = f.extend(!0, {}, i(s).tweensContainer);
                        for (var N in H)
                            if ("element" !== N) {
                                var L = H[N].startValue;
                                H[N].startValue = H[N].currentValue = H[N].endValue, H[N].endValue = L, m.isEmptyObject(x) || (H[N].easing = l.easing), b.debug && console.log("reverse tweensContainer (" + N + "): " + JSON.stringify(H[N]), s)
                            }
                        p = H
                    } else if ("start" === F) {
                        var H;
                        i(s).tweensContainer && i(s).isAnimating === !0 && (H = i(s).tweensContainer), f.each(v, function(e, t) {
                            if (RegExp("^" + S.Lists.colors.join("$|^") + "$").test(e)) {
                                ...
                                if (S.RegEx.isHex.test(n)) {
                                    for (var s = ["Red", "Green", "Blue"], l = S.Values.hexToRgb(n), u = i ? S.Values.hexToRgb(i) : a, c = 0; c < s.length; c++) {
                                        var p = [l[c]];
                                        o && p.push(o), u !== a && p.push(u[c]), v[e + s[c]] = p
                                    }
                                    delete v[e]
                                }
                            }
                        ...
                        for (var z in v) {
                            ...
                            var B = S.Hooks.getRoot(z),
                                W = !1;
                            if (i(s).isSVG || S.Names.prefixCheck(B)[1] !== !1 || S.Normalizations.registered[B] !== a) {
                                (l.display !== a && null !== l.display && "none" !== l.display || l.visibility !== a && "hidden" !== l.visibility) && /opacity|filter/.test(z) && !I && 0 !== M && (I = 0), l._cacheValues && H && H[z] ? (I === a && (I = H[z].endValue + H[z].unitType), W = i(s).rootPropertyValueCache[B]) : S.Hooks.registered[z] ? I === a ? (W = S.getPropertyValue(s, B), I = S.getPropertyValue(s, z, W)) : W = S.Hooks.templates[B][1] : I === a && (I = S.getPropertyValue(s, z));
                                var G, D, X, Y = !1;
                                if (G = g(z, I), I = G[0], X = G[1], G = g(z, M), M = G[0].replace(/^([+-\/*])=/, function(e, t) {
                                        return Y = t, ""
                                    }), D = G[1], I = parseFloat(I) || 0, M = parseFloat(M) || 0, "%" === D && (/^(fontSize|lineHeight)$/.test(z) ? (M /= 100, D = "em") : /^scale/.test(z) ? (M /= 100, D = "") : /(Red|Green|Blue)$/i.test(z) && (M = M / 100 * 255, D = "")), /[\/*]/.test(Y)) D = X;
                                else if (X !== D && 0 !== I)
                                    if (0 === M) D = X;
                                    else {
                                        o = o || h();
                                        ...
                                        switch (X) {
                                            case "%":
                                                I *= "x" === Q ? o.percentToPxWidth : o.percentToPxHeight;
                                                break;
                                            case "px":
                                                break;
                                            default:
                                        ...
                                        switch (D) {
                                            case "%":
                                                I *= 1 / ("x" === Q ? o.percentToPxWidth : o.percentToPxHeight);
                                                break;
                                            case "px":
                                                break;
                                            default:
                                ...
                                p[z] = {
                                    ...
                                    unitType: D,
                                    easing: $
                                }, b.debug && console.log("tweensContainer (" + z + "): " + JSON.stringify(p[z]), s)
                        ...
                        if (!f.isPlainObject(v) || m.isEmptyObject(v)) {
                            if (m.isString(v) && b.Redirects[v]) {
                                ...
                                return j.backwards === !0 && (y = f.extend(!0, [], y).reverse()), f.each(y, function(e, t) {
                                    parseFloat(j.stagger) ? j.delay = N + parseFloat(j.stagger) * e : m.isFunction(j.stagger) && (j.delay = N + j.stagger.call(t, e, V)), j.drag && (j.duration = parseFloat(H) || (/^(callout|transition)/.test(v) ? 1e3 : h),
                                        j.duration = Math.max(j.duration * (j.backwards ? 1 - e / V : (e + 1) / V), .75 * j.duration, 200)), b.Redirects[v].call(t, t, j || {}, e, V, y, A.promise ? A : a)
                                }), e()
                            }
...
! function(t) {
    ...
    return function(t, a, e, r) {
        ...
        i.RegisterEffect = i.RegisterUI = function(t, a) {
            function e(t, a, e, r) {
                var n, o = 0;
                s.each(t.nodeType ? [t] : t, function(t, a) {
                    r && (e += t * r), n = a.parentNode, s.each(["height", "paddingTop", "paddingBottom", "marginTop", "marginBottom"], function(t, e) {
                        o += parseFloat(i.CSS.getPropertyValue(a, e))
                    })
                }), i.animate(n, {
                    height: ("In" === a ? "+" : "-") + "=" + o
                }, {
            ...
            return i.Redirects[t] = function(n, o, l, c, u, f) {
                function p() {
                    o.display !== r && "none" !== o.display || !/Out$/.test(t) || s.each(u.nodeType ? [u] : u, function(t, a) {
                        i.CSS.setPropertyValue(a, "display", "none")
                    }), o.complete && o.complete.call(u, u), f && f.resolver(u || n)
                }
                var d = l === c - 1;
                a.defaultDuration = "function" == typeof a.defaultDuration ? a.defaultDuration.call(u, u) : parseFloat(a.defaultDuration);
                for (var g = 0; g < a.calls.length; g++) {
                    var y = a.calls[g],
                        m = y[0],
                        X = o.duration || a.defaultDuration || 1e3,
                        Y = y[1],
                        O = y[2] || {},
                        v = {};
                    if (v.duration = X * (Y || 1), v.queue = o.queue || "", v.easing = O.easing || "ease", v.delay = parseFloat(O.delay) || 0, v._cacheValues = O._cacheValues || !0, 0 === g) {
                        if (v.delay += parseFloat(o.delay) || 0, 0 === l && (v.begin = function() {
                                o.begin && o.begin.call(u, u);
                                var a = t.match(/(In|Out)$/);
                                a && "In" === a[0] && m.opacity !== r && s.each(u.nodeType ? [u] : u, function(t, a) {
                                    i.CSS.setPropertyValue(a, "opacity", 0)
                                }), o.animateParentHeight && a && e(u, a[0], X + v.delay, o.stagger)
                            }), null !== o.display)
                    ...
                    }, "hidden" === o.visibility && (v.visibility = o.visibility)), i.animate(n, m, v)
                }
            }, i
        ...
        i.RunSequence = function(t) {
            ...
            a.length > 1 && (s.each(a.reverse(), function(t, e) {
                var r = a[t + 1];
                if (r) {
                    var n = e.options && e.options.sequenceQueue === !1 ? "begin" : "complete",
                        o = r.options && r.options[n],
                        l = {};
                    l[n] = function() {
                        var t = r.elements || r.e,
                            a = t.nodeType ? [t] : t;
                        o && o.call(a, a), i(e)
...
! function(e) {
    ...
    window.Tiles = function() {
        ...
        function t() {
            var i = e(".js-main-image").eq(0).attr("src");
            i && g.tiles.css("background-image", "url(" + i + ")")
        }

        function a() {
            g.app.on("animation.finished", function() {
                g.app.removeClass("animating")
            })
        }

        function o() {
            g.mainPage.unbind("mouseenter.hoverIntent mouseleave.hoverIntent")
        }

        function r() {
            return g.mainPage.hasClass("active") ? !0 : !1
        }

        function l() {
            setTimeout(function() {
                g.tiles.addClass("explode"), g.mainPage.is(":hover") && v.mend()
            }, 500)
        }

        function u(e) {
            for (var i, n, t = e.length; t; i = Math.floor(Math.random() * t), n = e[--t], e[t] = e[i], e[i] = n);
            return e
        }

        function d(i, n) {
            var t = u(g.tiles);
            "forward" === i ? t.each(function(i) {
                var a = e(this);
                setTimeout(function() {
                    g.app.addClass("animating"), a.addClass("rotate-forward"), i === t.length - 1 && setTimeout(function() {
                        n()
                    }, 800)
                }, 50 * i)
            }) : t.each(function(i) {
                var n = e(this);
                setTimeout(function() {
                    n.removeClass("rotate-forward"), i === t.length - 1 && setTimeout(function() {
                        g.app.trigger("animation.finished")
                    }, 800)
                }, 50 * i)
            })
        }
        ...
        function f(i, n) {
            i.addClass("active");
            var t = 150;
            e(".active.section .js-animated-content").velocity("transition.slideDownIn", {
                stagger: t
            }), e(".active.section .js-animated-video").velocity("transition.fadeIn"), n !== !0 && (e(".js-section-nav").css("visibility", "visible"), e(".js-section-nav .section-nav-elem").velocity("transition.slideLeftIn", {
                stagger: t
            })), setTimeout(function() {
                e(".active.section .js-scroll-bar").velocity({
                    translateX: "40px",
                    opacity: 1
                }, {
                    easing: "easeOutExpo",
        ...
        function p(i, n) {
            var t = ".active.section .js-animated-content, .active.section .js-animated-video, .active.section .js-scroll-bar";
            g.app.addClass("animating"), c.pauseAll(), n !== !0 && (t += ", .js-section-nav .section-nav-elem"), e(t).velocity("reverse", {
                complete: function() {
                    n !== !0 && e(".js-section-nav").css("visibility", "hidden"), e(".js-section.active").removeClass("active"), i()
                },
                duration: 250
            })
        }
        var v = {},
            g = {
                img: e(".js-main-image"),
                tiles: e(".js-tile"),
                mainPage: e("#main-page"),
                app: e(".js-app"),
                sections: e(".js-section"),
                
            };
        return v.init = function() {
            t(), g.mainPage.addClass("active"), v.showTiles(), n(), a(), i.init(), i.bindResize(), v.about()
        }, v.bindGoToTiles = function() {
            e(".js-goto").unbind().click(function(i) {
                i.preventDefault(), v.open(e(this).data("target"))
            })
        }, v.bindGoToScroll = function() {
            e(".js-goto").unbind().click(function(i) {
                i.preventDefault(), e("html, body").animate({
                    scrollTop: e(e(this).data("target")).offset().top + "px"
                })
            })
        }, v.open = function(i) {
            var t = e(i);
            !t.length || g.app.hasClass("animating") || t.hasClass("active") || ("main-page" === t.attr("id") ? p(function() {
                d("backward"), g.mainPage.addClass("active"), n(), l()
            }) : r() ? (g.mainPage.removeClass("active"), v.mend(), o(), d("forward", function() {
                f(e(i))
            })) : p(function() {
                f(e(i), !0)
            }, !0)), s.close()
        }, v.openNext = function() {
            var e = g.sections.length,
                i = g.sections.filter(".active").index() - 1,
                n = i + 1;
            g.sections.filter(".active").length ? v.open("#" + g.sections.eq(n >= e ? 0 : n).attr("id")) : v.open("#" + g.sections.eq(0).attr("id"))
        }, v.openPrev = function() {
            var e = g.sections.length,
                i = g.sections.filter(".active").index() - 1,
                n = e - 1,
                t = i - 1;
            g.sections.filter(".active").length ? v.open("#" + g.sections.eq(0 > t ? n : t).attr("id")) : v.open("#" + g.sections.eq(0).attr("id"))
        }, v.reinitScroll = function(i) {
            e(i).length && e(i).find(".js-scroll-area").sly("reload")
        }, v.mend = function() {
            g.tiles.removeClass("explode")
        }, v.explode = function() {
            g.tiles.addClass("explode")
        }, v.showTiles = function() {
            g.tiles.addClass("loaded"), e(".js-menu-trigger").addClass("loaded"), l()
        }, v.about = function(){ $('*[data-target="#about-me"]').click()}, v
    }();
    var i = function() {
        var n = 1200,
            t = {
                sections: e(".js-section:not(.video-section)")
            },
            a = function() {
                var i = e(".js-next"),
                    n = e(".js-prev");
                i.click(function(e) {
                    e.preventDefault(), Tiles.openNext()
                }), n.click(function(e) {
                    e.preventDefault(), Tiles.openPrev()
                })
            },
            s = function() {
                e("body").keydown(function(i) {
                    e(window).outerWidth() > 1200 && (37 == i.keyCode ? Tiles.openPrev() : 38 == i.keyCode ? Tiles.open("#main-page") : 39 == i.keyCode && Tiles.openNext())
                })
            },
            o = function() {
                var i = t.sections.find(".js-scroll-area");
                i.each(function() {
                    var i = e(this),
                        n = i.parent().find(".js-scroll-bar");
                    i.sly({
                        speed: 300,
                        easing: "easeOutExpo",
                        scrollBar: n,
        ...
        return {
            init: function() {
                ...
                e("window").scrollTop(0), i > n ? (o(), a(), s(), Tiles.bindGoToTiles(), appInitialized = !0) : (Tiles.bindGoToScroll(), appInitialized = !1)
            },
            destroy: function() {
                var i = t.sections.find(".js-scroll-area");
                i.each(function() {
            ...
            bindResize: function() {
                ...
                e(window).on("resize", function() {
                    clearTimeout(t), t = setTimeout(function() {
                        ...
                        t > n && !appInitialized ? (i.init(), Tiles.bindGoToTiles(), appInitialized = !0) : n > t && appInitialized && (i.destroy(), Tiles.bindGoToScroll(), appInitialized = !1), "function" == typeof e(".js-scroll-area").sly && e(".js-scroll-area").sly("reload")
                    }, 250)
                })
            }
        }
    ...
    ! function() {
        e(".js-skill-item").each(function() {
            var i = e(this),
                n = i.find(".js-skill-progress"),
                t = i.data("progress");
            n.css("width", t + "%")
        })
    }();
    var n = function() {
            return {
                init: function() {
                    var i = e(".js-experience-slider"),
                        n = i.find(".experience-list-item");
                    i.owlCarousel({
                        loop: !0,
                        margin: 30,
                        nav: !0,
                        navText: ['<span class="js-prev-experience experience-nav exp-prev"><i class="fa fa-long-arrow-left"></i></span>', '<span class="js-next-experience experience-nav exp-next"><i class="fa fa-long-arrow-right"></i></span>'],
                        responsive: {
                            0: {
                                items: 1
                            },
        ...
        t = function() {
            return {
                initSquarePreviews: function() {
                    var i = e(".js-portfolio-preview");
                    i.each(function() {
                        var i = e(this),
                            n = i.outerWidth(),
                            t = i.outerHeight();
                        n > t ? i.addClass("preview-larger") : i.addClass("preview-higher")
                    })
                },
                init: function() {
        ...
        a = function() {
            return {
                init: function() {
                    ...
                    i.each(function() {
                        var i = e(this),
                            n = i.find(".accordion-title");
                        n.click(function(n) {
                            n.preventDefault();
                            var t = e(this),
                                a = t.closest(".accordion-item"),
                                s = e(".accordion-content", a);
                            s.hasClass("active") ? (t.removeClass("active"), s.stop().slideUp(function() {
                                Tiles.reinitScroll("#" + i.closest(".js-section").attr("id"))
                            }).removeClass("active")) : (t.addClass("active"), s.stop().slideDown(function() {
                                Tiles.reinitScroll("#" + i.closest(".js-section").attr("id"))
                            }).addClass("active"))
                        })
                    })
        ...
        s = function() {
            var i = e(".js-menu"),
                n = i.find(".js-menu-trigger"),
                t = i.find(".js-cover");
            return {
                init: function() {
                    var e = this;
                    n.click(function(i) {
                        i.stopPropagation(), e.open()
                    }), t.click(function(i) {
                        i.stopPropagation(), e.close()
                    })
                },
                open: function() {
                    i.addClass("active")
                ...
                init: function() {
                    if (e("#" + i).length) {
                        var t = document.getElementById(i),
                            a = new google.maps.LatLng(e(t).data("lon"), e(t).data("lat")),
                            s = {
                                zoom: 15,
                                center: a,
        ...
        l = function() {
            var i = e(".js-testimonial");
            return {
                init: function() {
                    i.responsiveEqualHeightGrid()
                }
            }
        }(),
        c = function() {
    ...
    e("body").queryLoader2({
        ...
        fadeOutTime: 250,
        onComplete: function() {
            n.init(), a.init(), s.init(), t.init(), o.init(), r.init(), l.init(), c.init(), Tiles.init()
        }
    })
}(jQuery);